...
//
// console.log(y) [where it is commented in the code] will print "undefined" as it is being referenced in a scope below its own
...
/*************************************************************************************
------------ ANSWER -------------------
console.log(x) will print undefined because it is declared after it is called.
console.log(y) will be undefined because it is non-existant. Did you mean 'y'?
console.log(foo()) will print "function hoisting", because the function "hoisted" and run before the .log call.
**************************************************************************************/
...
/**************************************************************************************
------------ ANSWER -------------------
console.log(add) inside the IIFE, not "IFEE", will log: 4. outside the IIFE will be undefined as the IIFE has not been added to the window object.
**************************************************************************************/
